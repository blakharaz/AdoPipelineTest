...
public class SimpleNodeJsPipelineTests
{
    ...
    public void VerifyBasics()
    {
        ...
        result.Stages[0].Jobs[0].Steps.Should().HaveCount(3);
    }
    ...
    public void VerifyStep1()
    {
        ...
        step1!.DisplayName.Should().Be("Install Node.js");
        step1.ContinueOnError.Should().BeFalse();
        step1.TaskName.Should().Be("NodeTool@0");
    }
    ...
    public void VerifyStep2()
    {
        ...
        step2!.DisplayName.Should().Be("npm install and build");
        step2.ContinueOnError.Should().BeFalse();
        step2.Script.Should().Contain("npm install").And.Contain("npm run build");
    }
    ...
    public void VerifyStep3()
    {
        ...
        step3!.DisplayName.Should().Be("npm test");
        step3.ContinueOnError.Should().BeTrue();
        step3.Script.Should().Contain("npm test");
    }
}
