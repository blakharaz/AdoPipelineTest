...
{
    public PipelineTestResultAssertions(PipelineTestResult subject, AssertionChain assertionChain)
    {
        Subject = subject;
    ...
    public AndConstraint<PipelineTriggersAssertions> HaveTriggers(string because = "", params object[] becauseArgs)
    {
        ...
        return new AndConstraint<PipelineTriggersAssertions>(new PipelineTriggersAssertions(Subject.Triggers!, AssertionChain));
    }
    ...
    public AndConstraint<PipelineAgentPoolAssertions> HaveAgentPool(string because = "", params object[] becauseArgs)
    {
        ...
        return new AndConstraint<PipelineAgentPoolAssertions>(new PipelineAgentPoolAssertions(Subject.AgentPool!, AssertionChain));
    }
